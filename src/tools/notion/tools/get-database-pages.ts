...
export const getDatabasePagesTool = defineTool(
    ...
    z.object({
        ...
        filters: z
            ...
            .optional()
            .describe("Optional filters to apply. Multiple filters are combined with AND logic."),
    ...
    async ({ database_id, filters, page_size }, _context) => {
        ...
        const pages = response.results
            .filter((page: unknown): page is PageObjectResponse => typeof page === "object" && page !== null && "properties" in page)
